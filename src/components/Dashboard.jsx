          ...
          <h1>
            ...
            <small>
              {this.state.startDate
                ? moment.utc(startDate).format("MMM DD, YYYY | HH:mm")
                : "Select start date"}
              &nbsp;&nbsp;—&nbsp;&nbsp;
              {this.state.endDate
                ? moment.utc(endDate).format("MMM DD, YYYY | HH:mm")
                : "Select end date"}
            </small>
          </h1>
        </div>
        <div className="dashboard__row">
          <div className="col">
            <ReactLightCalendar
              ...
              displayTime
              disableDates={(date) =>
                date > maxDate || date < minDate ? date : false
              }
              {...this.props}
            />
          </div>
