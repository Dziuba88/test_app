...
function DataTable({ columns, data }) {
  ...
  const handleClick = (id) => history.push(`/test_app/catalog/item-${id}`);
                  ...
                  <span>
                    {column.isSorted ? (
                      ...
                      <svg
                        ...
                        viewBox="0 0 64 64"
                      >
                        <path d="M22 2L8.7 15.3h10v23.4h6.7V15.3h10L22 2zm23.3 46.7V25.3h-6.7v23.4h-10L42 62l13.3-13.3h-10z" />
                      </svg>
                    )}
                  </span>
                </th>
